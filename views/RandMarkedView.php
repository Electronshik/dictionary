...
class RandMarkedView extends RandView
{
	public function index($dicts, $marked, $rand_word, $round=0, $count=0, $pron=FALSE, $pron_us=FALSE, $pron_uk=FALSE)
	{
...
<body>
	...
	<div class="content">
		...
		<nav>
			...
			<ul>
				<li><a href="/dict/marked" class="current">Отмеченные (<?=$marked?>)</a></li>
				<li>
					<a>Всего: <?=$amount?></a>
				</li>
			</ul>
		...
		<div class="main">
			...
			?>
			<form action="/rand/marked" method="post">
