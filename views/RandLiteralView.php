...
class RandLiteralView extends RandView
{
	public function index($dicts, $marked, $rand_word, $literal=NULL, $round=0, $count=0, $pron=FALSE, $pron_us=FALSE, $pron_uk=FALSE)
	{
...
<body>
	...
	<div class="content">
		...
		<div class="main">
			...
			?>
			<form action="/rand/literal/<?=$literal?>" method="post">
